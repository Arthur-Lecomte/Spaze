...
namespace Spaze {
    public class Assaillant : Enemy {
        ...
        /// <summary>
        /// Méthode appelée au démarrage. Initialise les paramètres de l'assaillant.
        /// </summary>
        ...
        /// <summary>
        /// Déplace l'assaillant vers le joueur ou le fait tourner autour du joueur.
        /// </summary>
        /// <param name="distanceToPlayer">La distance entre l'assaillant et le joueur.</param>
