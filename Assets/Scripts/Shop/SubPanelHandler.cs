...
public class SubPanelHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler {
    ...
    public void OnPointerEnter(PointerEventData eventData) {
        ...
        ShopUI.Instance.DimOtherConstructions(gameObject); // Dim other constructions
    }
    ...
    public void OnPointerExit(PointerEventData eventData) {
        ...
        ShopUI.Instance.RestoreConstructionsVisibility(); // Restore visibility
    }
